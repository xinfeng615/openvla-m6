...
Example:
    python vla-scripts/merge_lora_checkpoint.py \
        ...
        --adapter_checkpoint /root/autodl-tmp/openvla/output_m6/openvla-7b+metaworld_m6_50e+b16+lr-0.0005+lora-r32+dropout-0.0--image_aug/checkpoints/step-20000 \
        --output_dir /root/autodl-tmp/openvla/output_m6/openvla-7b+metaworld_m6_50e+b16+lr-0.0005+lora-r32+dropout-0.0--image_aug/merged-step-20000
"""
